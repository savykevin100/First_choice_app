...
class Panier2 extends StatefulWidget {
  ...
  Panier2({this.prixLivraison, this.nomComplet, this.total, this.telephone, this.lieuDeLivraison, this.quartier, this.indication, this.dateHeureDeLivraison, this.produitsCommander});
  @override
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      Container(
                        margin: EdgeInsets.only(top: longueurPerCent(30.0, context),right: longueurPerCent(0.0, context),left: longueurPerCent(50.0, context)),
                        child: Text(
                          "Numéro:",
                          textAlign: TextAlign.left,
                          style: TextStyle(
                      ...
                      Container(
                        width: largeurPerCent(190.0, context),
                        margin: EdgeInsets.only(top: longueurPerCent(30.0, context),right:longueurPerCent(0.0, context),left: longueurPerCent(30.0, context) ),
                        child: TextFormField(
                  ...
                  button( HexColor("#FFFFFF"), HexColor("#001C36"), context,  'COMMANDER', (){
                    if(numeroDePayement!=null && moyenDePayement!=null){
                      ...
                      try {
                        FirestoreService().addCommande(Commandes(
                        ...
                        FirestoreService().addCommandeToAdmin(Commandes(
                            nomComplet: widget.nomComplet,
                            telephone: widget.telephone,
                            quartier: widget.quartier,
                            indication: widget.indication,
