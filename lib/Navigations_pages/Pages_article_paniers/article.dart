...
class _ArticleSansTailleState extends State<ArticleSansTaille> {
  ...
  void initState() {
    ...
    widget.produit= Produit(nomDuProduit: widget.produitMap["nomDuProduit"], prix: widget.produitMap["prix"], description: widget.produitMap["description"], image1: widget.produitMap["image1"],
          ...
          children: <Widget>[
                        ...
                        if(snapshot.documents.isEmpty){
                          ...
                          setState(() {
                            ...
                            FirestoreService().addPanierSansId(PanierClasse(
                              ...
                              prix: widget.produitMap["prix"],
                              etatSurMesure: etatSurMesure,
                              taille: widget.produitMap["taille"],
                              description: widget.produitMap["description"],
            ...
            Padding(padding:  EdgeInsets.only(left: largeurPerCent(10, context)),
              child:  ConstrainedBox(
                ...
                child: Text((widget.produitMap["description"]==null)?"Pas de descritption":"${widget.produitMap["description"]}", style: TextStyle(
                    color: HexColor("#001c36"),
