    ...
    return Scaffold(
        ...
        body: Container(
          child:Column(
            children: <Widget>[
              Container(
                height: longueurPerCent(248.0, context),
                color:Colors.white,
                child: SingleChildScrollView(
                  ...
                  right: longueurPerCent(15.0, context),
                      ...
                      new Container(height: longueurPerCent(100.0, context),)
                    ],
                  ),
                ),
              ),
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        Container(
                          margin: EdgeInsets.only(top: longueurPerCent(20.0, context),right: longueurPerCent(0.0, context),left: longueurPerCent(36.0, context)),
                          child: Text(
                            "LIVRAISON",
                            textAlign: TextAlign.left,
                            style: TextStyle(
                        ...
                        Container(
                          width: largeurPerCent(190.0, context),
                          margin: EdgeInsets.only(top: longueurPerCent(20.0, context),right:longueurPerCent(25.0, context),left: longueurPerCent(39.0, context) ),
                          child: Text(
                            "500" +"‬ F CFA",
                            textAlign: TextAlign.right,
                            style: TextStyle(
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        Container(
                          width: largeurPerCent(190.0, context),
                          margin: EdgeInsets.only(top: longueurPerCent(20.0, context),right:longueurPerCent(25.0, context),left: longueurPerCent(85.0, context) ),
                          child: Text(
                            "1.500" +"‬ F CFA",
                            textAlign: TextAlign.right,
                            style: TextStyle(
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        Container(
                          width: largeurPerCent(190.0, context),
                          margin: EdgeInsets.only(top: longueurPerCent(30.0, context),right:longueurPerCent(0.0, context),left: longueurPerCent(20.0, context) ),
                          child: Text(
                            "96 18 46 55",
                            textAlign: TextAlign.left,
                            style: TextStyle(
