...
class ConditionGenerales1 extends StatefulWidget {
  static String id="ConditionGenerales1";
  @override
  _ConditionGenerales1State createState() => _ConditionGenerales1State();
}

class _ConditionGenerales1State extends State<ConditionGenerales1> {
