...
class _AffichageCommandesState extends State<AffichageCommandes> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: StreamBuilder(
            stream:  FirestoreService().getUserOrder(),
                                  ...
                                  Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        padding: EdgeInsets.only(
                                            right:
                                                longueurPerCent(12, context)),
                                        child: PriceWithDot(
                                          price: commande.sousTotal,
                                          size: 12,
